...
function addprotest(id,proName,proType,proprice,proNum,proSrc,proext) {
    ...
    $("#prod_Ulist").append("<li class='prod_Item modSet'>" +
       ...
       + "<div class='relative'>" +
        ...
        "<div class='prod_img'><a href='buyone?phone="+phone+"&id="+id+"&bianhao="+bianhao+"' target='_self'><img id='img"+id+"' class='pro_img horizontal' src='"+proSrc+"' /><span></span></a></div>" +
        ...
        "<div class='p_line'>\n" +
        "</div>\n" +
        "<div class=\"p_name titleSet mobile\"><a href='buyone?phone="+phone+"&id="+id+"&bianhao"+bianhao+"' target=\"_self\"><input type='text' id='text"+id+"' value='"+proName+"' class='producterinput' readonly='readonly'></a></div>\n" +
